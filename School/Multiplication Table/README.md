<h2><a href="https://practice.geeksforgeeks.org/problems/print-table0303/1">Multiplication Table</a></h2><h3>Difficulty Level : School</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Create the multiplication table of a given number <strong>N&nbsp;</strong>and return the table as an array.</span></p>
